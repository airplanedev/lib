...
func (td TaskDirectory) ReadDefinition(logger logger.Logger) (definitions.Definition, error) {
...
func (td TaskDirectory) ReadDefinition_0_3(logger logger.Logger) (definitions.Definition_0_3, error) {
	buf, err := ioutil.ReadFile(td.defPath)
	if err != nil {
