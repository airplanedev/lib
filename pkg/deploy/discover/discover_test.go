			...
			want: []TaskConfig{
				{
					...
					FilePath: fixturesPath + "/single_task.js",
		...
		},
		{
			...
			want: []TaskConfig{
				...
				},
				{
					...
					FilePath: fixturesPath + "/single_task2.js",
					From:     TaskConfigSourceScript,
				},
			},
			buildConfigs: []build.BuildConfig{
			...
			want: []TaskConfig{
				{
					...
					Task:     api.Task{Slug: "my_task", Kind: build.TaskKindNode},
					FilePath: fixturesPath + "/nestedScripts/single_task.js",
					From:     TaskConfigSourceScript,
				},
				{
					TaskRoot:       fixturesPath + "/nestedScripts",
					...
					Task:     api.Task{Slug: "my_task2", Kind: build.TaskKindNode},
					FilePath: fixturesPath + "/nestedScripts/single_task2.js",
					From:     TaskConfigSourceScript,
				},
			},
			buildConfigs: []build.BuildConfig{
			...
			want: []TaskConfig{
				{
					...
					Task:     api.Task{Slug: "my_task", Kind: build.TaskKindNode},
					FilePath: fixturesPath + "/defn.task.yaml",
			...
			want: []TaskConfig{
				{
					...
					Task:     api.Task{Slug: "my_task", Kind: build.TaskKindNode},
					FilePath: fixturesPath + "/subdir/single_task.js",
					From:     TaskConfigSourceScript,
				},
			},
			buildConfigs: []build.BuildConfig{
			...
			want: []TaskConfig{
				{
					...
					Task:     api.Task{Slug: "my_task", Kind: build.TaskKindNode},
					FilePath: fixturesPath + "/subdir/defn.task.yaml",
					From:     TaskConfigSourceDefn,
				},
			},
			buildConfigs: []build.BuildConfig{
